...
import '../pages/homeContentPosts.css';
    ...
    return (
        <> 
            <div className="Home-Content_Overview">
                <div className="Home-Content_Overview_Posts">
                    {
                        (loading === true) ? "" : (
                            posts[0].map( (e, index) => {
                                return (
                                    <div key={index} className="Home-Content_Overview_Posts_Post">
